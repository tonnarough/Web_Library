...
public class Book implements Entity {
    ...
    @Column(name = "mtm_author_id")
    private List<Author> authors = new ArrayList<>();
    @Column(name = "mtm_genre_id")
    private List<Genre> genres = new ArrayList<>();
    @Column(name = "mtm_publishing_house_id")
    ...
    public Book(int id, String title, String description, String ageLimit, int numberOfPages, String file, String picture) {
        this.id = id;
        this.title = title;
