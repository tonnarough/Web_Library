...
const bookTitle = document.getElementById('title_id');
const ageLimit = document.getElementById('age_limit_id');
const genreTitle = document.getElementById('genre_id');
const authorLastName = document.getElementById('last_name_id');
const authorFirstName = document.getElementById('first_name_id');
const publishingTitle = document.getElementById('publishingHouse_title_id');
const yearOfPublishing = document.getElementById('publishingHouse_year_id');
